  ...
  <div id="user">
    <div class="user-msg">
        <label style="display: inline-block;padding-left: 50px">
          <button type="button" @click="opeShow('处理详情')" class="btn btn-primary">审核</button>
        </label>
        <label style="display: inline-block;padding-left: 10px">
          <button type="button" @click="opeShow('处理详情')" class="btn btn-primary">审核通过</button>
        </label>
        <label style="display: inline-block;padding-left: 10px">
          <button type="button" @click="opeShow('处理详情')" class="btn btn-primary">审核不通过</button>
        </label>
    </div>
