<template>
    <div id="user">
        ...
        <div class="operating">
            <button type="button" @click="opeShow('现场实名注册')">现场实名注册</button>
            <button type="button" @click="opeShow('实名认证')">实名认证</button>
            <button type="button" @click="opeShow('账号管理')">账号管理</button>
        </div>
