<template>
  <div id="user">
    ...
    <div class="operating">
      <button type="button" @click="opeShow('处理详情')">新建</button>
      <button type="button" @click="opeShow('处理详情')">编辑</button>
      <button type="button" @click="opeShow('处理详情')">删除</button>
      <button type="button" @click="opeShow('处理详情')">添加到常见问答</button>
    </div>
